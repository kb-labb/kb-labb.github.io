...
```{r out.width = "25%"}
knitr::include_graphics("images/hillevi.jpg")
```
### Hillevi Hägglöf, Data Scientist [`r emo::ji("e-mail")`](mailto:hillevi.hagglof@kb.se)

I am a computational linguist and data scientist with a background in corporate research. I love data and I want to make the incredible collections of the National Library of Sweden easily available to all who wish to learn from them. My main focus as an NLP developer is to create and evaluate language models and their applications. Some of my interests include natural language generation, semantics and ethical AI. I sometimes give talks on language and machine learning.

<br />
<br />

```{r out.width = "25%"}
knitr::include_graphics("images/justyna.jpg")
```
### Justyna Sikora, Data scientist [`r emo::ji("e-mail")`](mailto:justyna.sikora@kb.se)
...
```{r out.width = "25%"}
knitr::include_graphics("images/patrik.jpg")
```

### Patrik Granholm, Researcher [`r emo::ji("e-mail")`](mailto:patrik.granholm@kb.se)
