...
author:
  - name: Markus Forsberg
    affiliation: Språkbanken Text
  - name: Emma Sköldberg
    affiliation: Språkbanken Text
  - name: Justyna Sikora
    affiliation: KBLab
date: 2023-08-29
preview: kubord_prev.png
output:
...
<aside>
```{r annotation, fig.height=6, fig.cap="Kubord 2 data available in the research tool Korp."}
knitr::include_graphics("kubord2.png")
```
</aside>
...
```{r, out.width = "180%", fig.cap="Wordpicture for "}
knitr::include_graphics("wordpicture.png")
```
