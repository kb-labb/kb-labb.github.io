...
<aside>
The scripts to generate the SUC3.1 data from the original data supplied by Språkbanken, as well as the code for HPO and some additional information can be accessed at https://github.com/kb-labb/suc3_1.
</aside>
