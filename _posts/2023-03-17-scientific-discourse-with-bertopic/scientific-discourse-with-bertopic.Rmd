...
author:
  ...
  - name: Justyna Sikora
    affiliation: KBLab
preview: Forskarsalen_1920-talet.jpg
#date: 05-04-2023
output:
...
```{r a}
htmltools::includeHTML("intertopic.html")
...
```{r, out.width = "200%", fig.cap="Hierarchical topic structure of scientific abstracts in the field of education 1990-2022"}
knitr::include_graphics("hierarchy.png")
```
...
```{r, out.width = "200%", fig.cap="Online learning topics over time."}
knitr::include_graphics("topics_over_time.png")
```
...
```{r, out.width = "200%", fig.cap="Correspondence analysis visualization over topics and author affiliation."}
knitr::include_graphics("ca_education_50_countries.png")
```
...
Part of this development work was carried out within the frame of the infrastruc
tural project [HUMINFRA](https://www.huminfra.se/).
