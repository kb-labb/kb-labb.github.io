...
author:
  ...
  - name: Chris Haffenden
    affiliation: KBLab
date: 2022-06-14
preview: Bertopic_algorithm.png
output:
...
```{r, out.width = "180%", fig.cap="Intertopic distance map for a topic model of Swedish governmental reports (SOUs) on education between 1970-2021"}
knitr::include_graphics("Bertopic1.png")
```
...
Topic models can be used in many ways, for example to follow the development of a concept over time or to analyze subtopics of a given issue (see figures 2 and 3). The main insight is in utilizing data mining algorithms to make vast amounts of data searchable—and thus legible—according to the particular themes of which it is comprised.

```{r, out.width = "180%", fig.cap="Topics over time for model of Swedish governmental reports (SOUs) on education between 1970-2021"}
knitr::include_graphics("Bertopic4.png")
```
...
```{r, out.width = "180%", fig.cap="Hierarchical clustering of topics for a model of Swedish governmental reports (SOUs) on education between 1970-2021"}
knitr::include_graphics("Bertopic2.png")
```
