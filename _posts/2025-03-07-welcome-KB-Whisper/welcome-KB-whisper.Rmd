...
preview: images/KBLab-whisper.jpg
output:
...
```{r KBLab-whisper, echo=FALSE, out.width="300%", fig.cap="The team behind KB-Whisper. Back row: Agnes Toftgård, Robin Kurtz, Justyna Sikora. Front row: Leonora Vesterbacka, Faton Rekathati. Photography: Lina Löfström Baker/KB"}
knitr::include_graphics("images/KBLab-whisper.jpg")
```
...
```{r dsf, echo=FALSE, out.width="300%", fig.cap="The team behind KB-Whisper. Back row: Agnes Toftgård, Robin Kurtz, Justyna Sikora. Front row: Leonora Vesterbacka, Faton Rekathati. Photography: Lina Löfström Baker/KB"}
knitr::include_graphics("images/KBLab-team.jpg")
```
...
```{r edit, echo=FALSE, out.width="300%", fig.cap="From the audiovisual archives of the National Library of Sweden. Photography: Lina Löfström Baker/KB"}
knitr::include_graphics("images/bandrulle.jpg")
```
...
```{r leonardo, echo=FALSE, out.width="300%", fig.cap="The Leonardo Supercomputer. Source [CINECA](https://leonardo-supercomputer.cineca.eu/)"}
knitr::include_graphics("images/leonardo.png")
```
...
knitr::include_graphics("images/eurohpc.png")
```
</aside>
