...
```{r runstones, echo=FALSE, out.width="300%", fig.cap="The team behind KB-Whisper. Photography: Lina Löfström Baker/KB"}
...
```{r capsules, echo=FALSE, out.width="300%", fig.cap="From the audiovisual archives of the National Library of Sweden. Photography: Lina Löfström Baker/KB"}
