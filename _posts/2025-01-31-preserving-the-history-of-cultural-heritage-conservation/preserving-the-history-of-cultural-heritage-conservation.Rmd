...
```{r runstones, echo=FALSE, out.width="300%", fig.cap="This page spread from Jonas Haquini Rhezelius, *Runestones in Uppland* (n.d. before 1666) - available in full here: [Fc 8](https://www.manuscripta.se/ms/101823) - is one of the many sketch illustrations waiting to be found in KB’s F-collection."}
...
```{r capsules, echo=FALSE, out.width="300%", fig.cap="Storage capsules, covers and boxes from many generations coexist in the F-collection. Some have withstood the test of time well, while others need to be inspected and replaced."}
...
```{r seal, out.width="300%", echo=FALSE, fig.cap="Reattaching a detached wax and paper seal."}
...
```{r ascheneus, echo=FALSE, out.width="300%", fig.cap="Unexpected coins nesting as part of the book. Aschaneus’ *Collectaneum monetalium seu monetoscopia Sweogothica* (n.d. before 1641),  [Fb 17:2](https://www.manuscripta.se/ms/101809)."}
...
```{r brigitta, echo=FALSE, out.width="300%", fig.cap="Shoring these fragments from ruin. Peringskiöld’s *Om Heliga Birgitta* (n.d.,1680-1720), Fh 26. Top right: before intervention. Bottom right: highlighting the damage of time. Left: after preservation measures. "}
...
```{r konungatal, echo=FALSE, out.width="300%", fig.cap="Mediating social order via extended diagrams. Peringskiöld, *Konungatal eller förteckning på Svea och Göta Rikes konungar och drottningar*, (n.d. before 1720), [Fh 13](https://www.manuscripta.se/ms/101917)."}
