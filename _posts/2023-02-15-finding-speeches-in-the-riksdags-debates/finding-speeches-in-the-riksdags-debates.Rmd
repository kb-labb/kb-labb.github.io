...
knitr::include_graphics("riksmotets-oppnande-2022_kammaren2.jpg")
```
The Chamber.  
...
function embedLinkGetter(debateurl, start, end){
  ...
  embed_url = base_url + debateurl + "&start=" + start + "&end=" + end;
  return embed_url
}
