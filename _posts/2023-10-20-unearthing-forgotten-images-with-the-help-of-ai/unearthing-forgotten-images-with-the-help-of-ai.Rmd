...
```{r embeddings, echo=FALSE, out.width="100%", fig.cap="Matching similar images and texts within vector space. Image: Federico Bianchi."}
knitr::include_graphics("images/embeddings.png")
```
...
```{r interface, layout="l-body-outset", echo=FALSE, out.width="100%", fig.cap="Interface for postcard image search."}
...
```{r kyrka, layout="l-body-outset", echo=FALSE, out.width="100%", fig.cap='Free text search in the postcard collection for the Swedish term “church”.'}
knitr::include_graphics("images/kyrka.png")
```

```{r kyrkabilar, layout="l-body-outset", echo=FALSE, out.width="100%", fig.cap='Search results for the Swedish search string: “church and blue sky cars”.'}
knitr::include_graphics("images/kyrka_bilar.png")
```

```{r imagetoimage, layout="l-body-outset", echo=FALSE, out.width="100%", fig.cap='Image-to-image search to find most closely related postcards.'}
knitr::include_graphics("images/image_to_image.png")
```
...
```{r katt, layout="l-body-outset", echo=FALSE, out.width="100%", fig.cap='Searching for the non-existent “cat” in the postcard collection.'}
knitr::include_graphics("images/katt.png")
```
