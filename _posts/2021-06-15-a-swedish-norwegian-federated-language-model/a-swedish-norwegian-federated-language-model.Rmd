...
```{r, fig.width=6, fig.height=1.5, fig.cap="Loss plotted over the number of gradient updates for three runs with round times set to 100, 1000, and 5000 steps."}
...
```{r, fig.width=6, fig.height=1.5, fig.cap="Loss plotted over real-time minutes for three runs with round times set to 100, 1000, and 5000 steps."}
...
```{r, fig.width=6, fig.height=1.5, fig.cap="Loss plotted over the number of gradient updates for two runs with a global and a local optimizer."}
...
```{r, fig.width=6, fig.height=1.5, fig.cap="Loss plotted over real-time minutes for two runs with a global and a local optimizer."}
