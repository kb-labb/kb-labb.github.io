...
<aside>
```{r, fig.retina=5, fig.cap="Electra at the Tomb of Agamemnon, Frederic Leighton c. 1869"}
knitr::include_graphics("images/electra.jpg")
```
</aside>
...
```{r, fig.width=6, fig.height=1.5, fig.cap="Schema for the hierarchical federated learning architecture implemented in FEDn."}
knitr::include_graphics("images/HFedAvg.png")
```
...
```{r, fig.width=6, fig.height=1.5, layout="l-body-outset", fig.cap="Loss plotted over the number of gradient updates for three runs with round times set to 100, 1000, and 5000 steps."}
knitr::include_graphics("images/round_lengths_steps.png")
```
...
```{r, fig.width=6, fig.height=1.5, layout="l-body-outset", fig.cap="Loss plotted over real-time minutes for three runs with round times set to 100, 1000, and 5000 steps."}
knitr::include_graphics("images/round_lengths_time_long.png")
```
...
```{r, fig.width=6, fig.height=1.5, layout="l-body-outset", fig.cap="Loss plotted over the number of gradient updates for two runs with a global and a local optimizer."}
knitr::include_graphics("images/local_v_global_steps.png")
```
...
```{r, fig.width=6, fig.height=1.5, layout="l-body-outset", fig.cap="Loss plotted over real-time minutes for two runs with a global and a local optimizer."}
knitr::include_graphics("images/local_v_global_time.png")
```
